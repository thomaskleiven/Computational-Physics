...
p_c = 0.499498997996
n_sites = np.sqrt(np.array([100**2, 200**2, 400**2, 500**2, 600**2, 700**2, 800**2]))

data_100 = np.loadtxt('res_square/avg100.csv', delimiter='\n')[10:-10]
data_200 = np.loadtxt('res_square/avg200.csv', delimiter='\n')[10:-10]
#data_300 = np.loadtxt('res_square/avg300.csv', delimiter='\n')[10:-10]
data_400 = np.loadtxt('res_square/avg400.csv', delimiter='\n')[10:-10]
data_500 = np.loadtxt('res_square/avg500.csv', delimiter='\n')[10:-10]
data_600 = np.loadtxt('res_square/avg600.csv', delimiter='\n')[10:-10]
data_700 = np.loadtxt('res_square/avg700.csv', delimiter='\n')[10:-10]
data_800 = np.loadtxt('res_square/avg800.csv', delimiter='\n')[10:-10]
#data_900 = np.loadtxt('results/avg900.csv', delimiter='\n')[10:-10]
#data_1000= np.loadtxt('res_square/avg1000.csv', delimiter='\n')[10:-10]

#Calculate p_max
def calculate_p_max():
    values = np.array([data_100, data_200, data_400, data_500, data_600, data_700, data_800])
